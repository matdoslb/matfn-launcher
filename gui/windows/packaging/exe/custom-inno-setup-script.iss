...
begin
  Page := CreateInputOptionPage(
         wpWelcome,
        '   Allow DLL injection',
        ' The matFN Launcher needs to inject DLLs into Fortnite to create the game server',
        'Selecting the option below will add the matFN Launcher to the Windows Exclusions list. ' +
        ...
        'If you do not trust the matFN Launcher, you can audit the source code at https://github.com/matdoslb/og_launcher and build it from source.',
        False,
        False
  );
